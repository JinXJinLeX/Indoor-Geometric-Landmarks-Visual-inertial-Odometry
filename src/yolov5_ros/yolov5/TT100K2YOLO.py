    ...
    def divide_TrainValTest(self, source, target):
        ...
        for root, dirs, files in os.walk(source):
            for file in files:
                ...
                if 'train' in source:
                    shutil.copyfile('/media/scott/Studio/z/TT100K2016/image_reparation/'
...
if __name__ == '__main__':
    ...
    tt100k.divide_TrainValTest('/media/scott/Studio/z/TT100K2016/datasets/annotations/train', '/media/scott/Studio/z/TT100K/data')
    tt100k.divide_TrainValTest('/media/scott/Studio/z/TT100K2016/datasets/annotations/val', '/media/scott/Studio/z/TT100K/data')
    tt100k.divide_TrainValTest('/media/scott/Studio/z/TT100K2016/datasets/annotations/test', '/media/scott/Studio/z/TT100K/data')
