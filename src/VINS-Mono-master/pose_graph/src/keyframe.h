...
public:
	...
	// 20240917 xjl
	Eigen::Vector3d getSignLoopRelativeT();
	double getSignLoopRelativeYaw();
	Eigen::Quaterniond getSignLoopRelativeQ();
	void updateSignLoop(Eigen::Matrix<double, 8, 1> &_sign_loop_info);
